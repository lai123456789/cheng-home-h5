<template>
  <div class="page">
    <div class="top-video"> <!--  v-if="!show" -->
    <video controls="controls" autoplay="autoplay"  loop="loop"  id="audios">   <!--   poster="../../image/ttop.png" -->
<!--        <source src="http://mvmusic2.meitudata.com/video-replace.mp4" type="video/ogg" />-->
<!--        <source src="http://mvmusic2.meitudata.com/video-replace.mp4" type="video/mp4" />-->
      <source src="https://csfamily-1259120104.cos.ap-guangzhou.myqcloud.com/yearvideo/videoLast.mp4" type="video/ogg" />
      <source src="https://csfamily-1259120104.cos.ap-guangzhou.myqcloud.com/yearvideo/videoLast.mp4" type="video/mp4" />
      </video>
    </div>
    <div class="index">
      <div class="title">
        ...
        <div class="t2">感恩有你  一路相伴</div>
      </div>
      <div class="content">
          <div class="bg-cont">
            <div class="y1">成氏团圆年活动介绍</div>
            <div class="y2">
...
<script>
  ...
  document.addEventListener('WeixinJSBridgeReady', function() {
    ...
    import { getSporListApiF,getrecommendsApiF,IfbtnApiF,userInfoApiF } from "../../service/requestFun";
    import { jsConfigApi } from "../../service/apiUrl";
    import wechat from "../../common/js/wechat";
    import dateFormat from "../../utils/dateFormat";
    import equals from "../../utils/isSameObject";
    export default {
